...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Jhon Rel</span> Talmento
                <br />3rd Year
                <span class="poppins text-violet-400">Student</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                I'm <span class="text-violet-400"> BSCS</span> Student
    ...
    <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>
                    My Portfolio is a a merchanising store created with <strong
            ...
            <Step step={steps[2]}>
                <p>
                    My Work is a <strong class="text-violet-400"
    ...
    <section id="contact" class="py-20 pt-10 lg:pt-16 lg:py-32 flex flex-col gap-16 sm:gap-20 md:gap-24 relative">
        <div class="flex flex-col gap-4 items-center justify-center">
            ...
            <p><b class="pr-2">Email</b> jhonreltalmento@gmail.com</p>
            <p>
